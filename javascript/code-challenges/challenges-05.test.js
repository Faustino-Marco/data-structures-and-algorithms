...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((runningTotal, currentVal) => {
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((runTotal, currPrice) => {
    return runTotal + currPrice.purchasePrice;
  }, 0);
};
...
const reversedString = (str) => {
  ...
  return strArr.reduce((backwards, letter) => {
    return letter + backwards;
  }, '');
};
